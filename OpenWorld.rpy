...
#Add more lines eventually
    ...
    "Going to all these places make feel uneasy, but I feel safe knowing you're with me [player].",
...
screen OW_MENU():
    ...
    hbox:
        grid 2 2:
            ...
            textbutton ("GitHub") action NullAction() hover_sound gui.hover_sound
...
label OW_warning:
    if persistent.OW_splash_screen_warning == False:
        call screen dialog(message="The Following mod will contain scares and will contain topics of the other girls.\nPlease don't play the mod if you are sensitive about that stuff.", ok_action=Return())
    ...
    menu:
        ...
        "Yes":
            ...
            m "Huh? You want to take me somewhere?"
            m "You must have added something while I was looking."
            m "Alright, I can't wait to see what surpise you have for me, let's go."
            window hide
        ...
        "No":
            m "Oh... For a second you got me excited because it sounded like something special."
            m "It's okay, maybe some other time?"
            m "I really want to see what this is. I guess you can say it peaked my interest, ehehe~."
            jump ch30_loop
