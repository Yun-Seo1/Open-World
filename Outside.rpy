...
label OW_outside_mc_house:
    if persistent.OW_has_seen_outside == False:
        ...
        narrator "The slowly brings itself back together. Monika slowly opens her eyes in awe at what she's seeing."
        m 1d_owawm "W-what is happening? {w=1.0}[player]... A-are you bringing back my world?"
...
label OW_residential_beta:
    ...
    window hide
    $ consolehistory = []
    call updateconsole("Call Residential","Version 0.0.1")
    m 4d_owawm "Version 0.0.1?..."
